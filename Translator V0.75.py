...
def addfile(theme_set):
    ...
    window = sg.Window('Translator V0.9', layout, size=(565,300))
    window_1 = sg.Window('Translator V0.9', layout_1, size=(565,300))
